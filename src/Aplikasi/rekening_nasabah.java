...
ttglbayar.setEnabled(true);
tbayar_ang.setEnabled(true);
...
{
String[]judul={"No. Anggota","Total Pinjam ","Tanggal Bayar","Bayar Angsuran","Sisa Pinjaman"};
DefaultTableModel kolom=new DefaultTableModel(null,judul);
    try
    {
    con.setkoneksi();
    con.rs=con.st.executeQuery("select * from angsuran");
...
ttglbayar.setEnabled(false);
tbayar_ang.setEnabled(false);
...
bsimpan.setEnabled(true);
    ...
    private void initComponents() {
        ...
        ttglbayar = new javax.swing.JTextField();
        tsisa = new javax.swing.JTextField();
        tbayar_ang = new javax.swing.JTextField();
        ...
        jLabel1.setText("Angsuran Koperasi");
        ...
        jLabel3.setText("Total Pinjaman ");

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("Tgl. Bayar :");

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("Bayar Angsuran");

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel6.setText("Sisa Pinjaman ");
        ...
        ttglbayar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ttglbayarActionPerformed(evt);
            }
        });

        tsisa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tsisaActionPerformed(evt);
            }
        });

        tbayar_ang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbayar_angKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(tbayar_ang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(ttotal, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
                                    .addComponent(ttglbayar, javax.swing.GroupLayout.Alignment.LEADING)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ttglbayar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tbayar_ang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    if(evt.getKeyCode()==KeyEvent.VK_ENTER)
    {
        ...
        {
        con.setkoneksi();
        con.rs=con.st.executeQuery("select * from trans_pinjaman where no_ang='"+tkode.getText()+"'");
            if(con.rs.next())
            {
                JOptionPane.showMessageDialog(null,"Nomer Anggota Ditemukan");
                tkode.setText(con.rs.getString(3));
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        {
            con.setkoneksi();
            String sql="insert into angsuran values('"+tkode.getText()+"','"+ttotal.getText()+"','"+ttglbayar.getText()+"','"+tbayar_ang.getText()+"','"+tsisa.getText()+"')";
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        {
            con.setkoneksi();
            String sql="delete from angsuran where no_ang='"+tkode.getText()+"'";
            con.st.executeUpdate(sql);
            con.rs.close();
    ...
    private void bupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bupdateActionPerformed
        ...
        {
            con.setkoneksi();
            String sql="update angsuran set total='"+ttotal.getText()+"',tgl_bayar='"+ttglbayar.getText()+"',bayar_ang='"+tbayar_ang.getText()+"',sisa_pinj='"+tsisa.getText()+"' where no_ang='"+tkode.getText()+"'";
            con.st.executeUpdate(sql);
            con.rs.close();
    ...
    private void ttglbayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ttglbayarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ttglbayarActionPerformed
    ...
    private void tsisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tsisaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tsisaActionPerformed

    private void tbayar_angKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbayar_angKeyPressed
        // TODO add your handling code here:
         if(evt.getKeyCode()==KeyEvent.VK_ENTER)
        {
        double total=Double.parseDouble(ttotal.getText());
        double bayar=Double.parseDouble(tbayar_ang.getText());
        double sisa=total-bayar;
        tsisa.setText(Double.toString(sisa));
        
        }
    }//GEN-LAST:event_tbayar_angKeyPressed
    ...
    private javax.swing.JTextField tbayar_ang;
    private javax.swing.JTextField tkode;
    private javax.swing.JTextField tsisa;
    private javax.swing.JTextField ttglbayar;
